...
=head1 SYNOPSIS
  ...
  requires 'App::cpanminus',
    dist => 'MIYAGAWA/App-cpanminus-1.7907-TRIAL.tar.gz';
...
Options can be passed as key-value pairs following the optional
version requirement. The interpretation of these depends on the
tool reading the cpanfile. L<cpanm> currently supports the C<dist>,
C<mirror>, and C<url> options.
