...
FILE
    ...
    is_deeply $file->prereq_specs, {
        runtime => {
            requires => { 'git://github.com/plack/Plack.git' => 0 },
        },
    };

    my $got = $file->prereq_specs->{runtime}->{requires}->{'git://github.com/plack/Plack.git'};
    isa_ok $got, 'Module::CPANfile::Requirement';
    is_deeply $got->as_hashref, {
...
FILE
    ...
    is_deeply $file->prereq_specs, {
        runtime => {
            requires => { 'git://github.com/plack/Plack.git@0.9970' => 0 },
        },
    };

    my $got = $file->prereq_specs->{runtime}->{requires}->{'git://github.com/plack/Plack.git@0.9970'};
    isa_ok $got, 'Module::CPANfile::Requirement';
    is_deeply $got->as_hashref, {
        name     => 'git://github.com/plack/Plack.git',
        version  => 0,
